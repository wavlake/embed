      ...
      keyframes: {
        ...
        pump: {
          "0%": {
            height: "15px",
            transform:
              "translateY(0px)" /*translateY makes Y axis move down to give the effect that it is growing from the center*/,
            background: "#f3aef2",
          },
          "50%": { height: "40px", transform: "translateY(-25px)" },
        ...
        pumpShort: {
          ...
          "50%": { height: "25px", transform: "translateY(-10px)" },
          "70%": { background: "#ffeeff" },
          "100%": {
            height: "15px",
            transform: "translateY(0px)",
